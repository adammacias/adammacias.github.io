...
var Util = function(a) {
    ...
    var b = "alert", c = "4.0.0-alpha", d = "bs.alert", e = "." + d, f = ".data-api", g = a.fn[b], h = 150, i = {
        ...
        return _createClass(b, [ {
            ...
            key: "_getRootElement",
            value: function(b) {
                var c = Util.getSelectorFromElement(b), d = !1;
                return c && (d = a(c)[0]), d || (d = a(b).closest("." + k.ALERT)[0]), d;
            }
        }, {
            ...
            key: "_removeElement",
            value: function(b) {
                return a(b).removeClass(k.IN), Util.supportsTransitionEnd() && a(b).hasClass(k.FADE) ? void a(b).one(Util.TRANSITION_END, a.proxy(this._destroyElement, this, b)).emulateTransitionEnd(h) : void this._destroyElement(b);
            }
        }, {
            key: "_destroyElement",
            value: function(b) {
    ...
    return a(document).on(j.CLICK_DATA_API, i.DISMISS, l._handleDismiss(new l())), a.fn[b] = l._jQueryInterface, 
    a.fn[b].Constructor = l, a.fn[b].noConflict = function() {
    ...
    var b = "button", c = "4.0.0-alpha", d = "bs.button", e = "." + d, f = ".data-api", g = a.fn[b], h = {
        ACTIVE: "active",
        BUTTON: "btn",
        FOCUS: "focus"
    }, i = {
        ...
        return _createClass(b, [ {
            key: "toggle",
            value: function() {
                var b = !0, c = a(this._element).closest(i.DATA_TOGGLE)[0];
                if (c) {
                    var d = a(this._element).find(i.INPUT)[0];
                    if (d) {
                        if ("radio" === d.type) if (d.checked && a(this._element).hasClass(h.ACTIVE)) b = !1; else {
                            var e = a(c).find(i.ACTIVE)[0];
                            e && a(e).removeClass(h.ACTIVE);
                        }
                        b && (d.checked = !a(this._element).hasClass(h.ACTIVE), a(this._element).trigger("change"));
                    }
                } else this._element.setAttribute("aria-pressed", !a(this._element).hasClass(h.ACTIVE));
                b && a(this._element).toggleClass(h.ACTIVE);
            }
        }, {
            key: "dispose",
            value: function() {
    ...
    return a(document).on(j.CLICK_DATA_API, i.DATA_TOGGLE_CARROT, function(b) {
        b.preventDefault();
        var c = b.target;
        a(c).hasClass(h.BUTTON) || (c = a(c).closest(i.BUTTON)), k._jQueryInterface.call(a(c), "toggle");
    }).on(j.FOCUS_BLUR_DATA_API, i.DATA_TOGGLE_CARROT, function(b) {
        var c = a(b.target).closest(i.BUTTON)[0];
        a(c).toggleClass(h.FOCUS, /^focus(in)?$/.test(b.type));
    ...
    var b = "carousel", c = "4.0.0-alpha", d = "bs.carousel", e = "." + d, f = ".data-api", g = a.fn[b], h = 600, i = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
        ...
        function f(b, c) {
            _classCallCheck(this, f), this._items = null, this._interval = null, this._activeElement = null, 
            this._isPaused = !1, this._isSliding = !1, this._config = this._getConfig(c), this._element = a(b)[0], 
            this._indicatorsElement = a(this._element).find(n.INDICATORS)[0], this._addEventListeners();
        }
        return _createClass(f, [ {
            ...
            key: "prev",
            value: function() {
                this._isSliding || this._slide(k.PREVIOUS);
            }
        }, {
            key: "pause",
            value: function(b) {
                b || (this._isPaused = !0), a(this._element).find(n.NEXT_PREV)[0] && Util.supportsTransitionEnd() && (Util.triggerTransitionEnd(this._element), 
            ...
            key: "dispose",
            value: function() {
                a(this._element).off(e), a.removeData(this._element, d), this._items = null, this._config = null, 
            ...
            key: "_getConfig",
            value: function(c) {
                return c = a.extend({}, i, c), Util.typeCheckConfig(b, c, j), c;
            }
        }, {
            key: "_addEventListeners",
            value: function() {
                this._config.keyboard && a(this._element).on(l.KEYDOWN, a.proxy(this._keydown, this)), 
                "hover" !== this._config.pause || "ontouchstart" in document.documentElement || a(this._element).on(l.MOUSEENTER, a.proxy(this.pause, this)).on(l.MOUSELEAVE, a.proxy(this.cycle, this));
            }
        }, {
            key: "_keydown",
            value: function(a) {
            ...
            value: function(a, b) {
                var c = a === k.NEXT, d = a === k.PREVIOUS, e = this._getItemIndex(b), f = this._items.length - 1, g = d && 0 === e || c && e === f;
                if (g && !this._config.wrap) return b;
                var h = a === k.PREVIOUS ? -1 : 1, i = (e + h) % this._items.length;
                return -1 === i ? this._items[this._items.length - 1] : this._items[i];
            }
        }, {
            key: "_triggerSlideEvent",
            value: function(b, c) {
                var d = a.Event(l.SLIDE, {
                    relatedTarget: b,
                    direction: c
                });
            ...
            key: "_slide",
            value: function(b, c) {
                var d = this, e = a(this._element).find(n.ACTIVE_ITEM)[0], f = c || e && this._getItemByDirection(b, e), g = Boolean(this._interval), i = b === k.NEXT ? m.LEFT : m.RIGHT;
                if (f && a(f).hasClass(m.ACTIVE)) return void (this._isSliding = !1);
                var j = this._triggerSlideEvent(f, i);
                if (!j.isDefaultPrevented() && e && f) {
                    this._isSliding = !0, g && this.pause(), this._setActiveIndicatorElement(f);
                    var o = a.Event(l.SLID, {
                        relatedTarget: f,
                        direction: i
                    });
                    Util.supportsTransitionEnd() && a(this._element).hasClass(m.SLIDE) ? (a(f).addClass(b), 
                    Util.reflow(f), a(e).addClass(i), a(f).addClass(i), a(e).one(Util.TRANSITION_END, function() {
                        a(f).removeClass(i).removeClass(b), a(f).addClass(m.ACTIVE), a(e).removeClass(m.ACTIVE).removeClass(b).removeClass(i), 
                        d._isSliding = !1, setTimeout(function() {
                            return a(d._element).trigger(o);
                        }, 0);
                    }).emulateTransitionEnd(h)) : (a(e).removeClass(m.ACTIVE), a(f).addClass(m.ACTIVE), 
                    this._isSliding = !1, a(this._element).trigger(o)), g && this.cycle();
                }
            }
        } ], [ {
            key: "_jQueryInterface",
            value: function(b) {
                return this.each(function() {
                    var c = a(this).data(d), e = a.extend({}, i, a(this).data());
                    "object" == typeof b && a.extend(e, b);
                    var g = "string" == typeof b ? b : e.slide;
                    if (c || (c = new f(this, e), a(this).data(d, c)), "number" == typeof b) c.to(b); else if ("string" == typeof g) {
            ...
            value: function(b) {
                var c = Util.getSelectorFromElement(this);
                if (c) {
                    var e = a(c)[0];
                    if (e && a(e).hasClass(m.CAROUSEL)) {
                        var g = a.extend({}, a(e).data(), a(this).data()), h = this.getAttribute("data-slide-to");
                        h && (g.interval = !1), f._jQueryInterface.call(a(e), g), h && a(e).data(d).to(h), 
                        b.preventDefault();
                    }
                }
            }
    ...
    var b = "collapse", c = "4.0.0-alpha", d = "bs.collapse", e = "." + d, f = ".data-api", g = a.fn[b], h = 600, i = {
        toggle: !0,
        parent: ""
    }, j = {
        toggle: "boolean",
        ...
        function e(b, c) {
            _classCallCheck(this, e), this._isTransitioning = !1, this._element = b, this._config = this._getConfig(c), 
        ...
        return _createClass(e, [ {
            key: "toggle",
            value: function() {
                a(this._element).hasClass(l.IN) ? this.hide() : this.show();
            }
        }, {
            key: "show",
            value: function() {
                var b = this;
                if (!this._isTransitioning && !a(this._element).hasClass(l.IN)) {
                    var c = void 0, f = void 0;
                    if (this._parent && (c = a.makeArray(a(n.ACTIVES)), c.length || (c = null)), !(c && (f = a(c).data(d), 
                    f && f._isTransitioning))) {
                        var g = a.Event(k.SHOW);
                        if (a(this._element).trigger(g), !g.isDefaultPrevented()) {
                            c && (e._jQueryInterface.call(a(c), "hide"), f || a(c).data(d, null));
                            var i = this._getDimension();
                            a(this._element).removeClass(l.COLLAPSE).addClass(l.COLLAPSING), this._element.style[i] = 0, 
                            this._element.setAttribute("aria-expanded", !0), this._triggerArray.length && a(this._triggerArray).removeClass(l.COLLAPSED).attr("aria-expanded", !0), 
                            this.setTransitioning(!0);
                            var j = function() {
                                a(b._element).removeClass(l.COLLAPSING).addClass(l.COLLAPSE).addClass(l.IN), b._element.style[i] = "", 
                                b.setTransitioning(!1), a(b._element).trigger(k.SHOWN);
                            };
                            if (!Util.supportsTransitionEnd()) return void j();
                            var m = i[0].toUpperCase() + i.slice(1), o = "scroll" + m;
                            a(this._element).one(Util.TRANSITION_END, j).emulateTransitionEnd(h), this._element.style[i] = this._element[o] + "px";
                        }
                    }
                }
            }
            ...
            value: function() {
                ...
                if (!this._isTransitioning && a(this._element).hasClass(l.IN)) {
                    ...
                    if (a(this._element).trigger(c), !c.isDefaultPrevented()) {
                        ...
                        this._element.style[d] = this._element[e] + "px", Util.reflow(this._element), a(this._element).addClass(l.COLLAPSING).removeClass(l.COLLAPSE).removeClass(l.IN), 
                        this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && a(this._triggerArray).addClass(l.COLLAPSED).attr("aria-expanded", !1), 
                        this.setTransitioning(!0);
                        var f = function() {
                            b.setTransitioning(!1), a(b._element).removeClass(l.COLLAPSING).addClass(l.COLLAPSE).trigger(k.HIDDEN);
                        };
                        return this._element.style[d] = 0, Util.supportsTransitionEnd() ? void a(this._element).one(Util.TRANSITION_END, f).emulateTransitionEnd(h) : void f();
                    }
                }
            }
        }, {
            ...
            key: "dispose",
            value: function() {
                a.removeData(this._element, d), this._config = null, this._parent = null, this._element = null, 
                this._triggerArray = null, this._isTransitioning = null;
            }
        }, {
            key: "_getConfig",
            value: function(c) {
                return c = a.extend({}, i, c), c.toggle = Boolean(c.toggle), Util.typeCheckConfig(b, c, j), 
                c;
            }
        }, {
            key: "_getDimension",
            value: function() {
                var b = a(this._element).hasClass(m.WIDTH);
                return b ? m.WIDTH : m.HEIGHT;
            }
        }, {
            key: "_getParent",
            value: function() {
                ...
                return a(c).find(d).each(function(a, c) {
                    b._addAriaAndCollapsedClass(e._getTargetFromElement(c), [ c ]);
                }), c;
            }
        }, {
            ...
            value: function(b) {
                var c = Util.getSelectorFromElement(b);
                return c ? a(c)[0] : null;
            }
        }, {
            key: "_jQueryInterface",
            value: function(b) {
                return this.each(function() {
                    var c = a(this), f = c.data(d), g = a.extend({}, i, c.data(), "object" == typeof b && b);
                    if (!f && g.toggle && /show|hide/.test(b) && (g.toggle = !1), f || (f = new e(this, g), 
                    c.data(d, f)), "string" == typeof b) {
    ...
    return a(document).on(k.CLICK_DATA_API, n.DATA_TOGGLE, function(b) {
        b.preventDefault();
        var c = o._getTargetFromElement(this), e = a(c).data(d), f = e ? "toggle" : a(this).data();
    ...
    var b = "modal", c = "4.0.0-alpha", d = "bs.modal", e = "." + d, f = ".data-api", g = a.fn[b], h = 300, i = 150, j = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
        ...
        function f(b, c) {
            _classCallCheck(this, f), this._config = this._getConfig(c), this._element = b, 
            this._dialog = a(b).find(n.DIALOG)[0], this._backdrop = null, this._isShown = !1, 
        ...
        return _createClass(f, [ {
            ...
            key: "show",
            value: function(b) {
                var c = this, d = a.Event(l.SHOW, {
                    relatedTarget: b
                });
                a(this._element).trigger(d), this._isShown || d.isDefaultPrevented() || (this._isShown = !0, 
                this._checkScrollbar(), this._setScrollbar(), a(document.body).addClass(m.OPEN), 
                this._setEscapeEvent(), this._setResizeEvent(), a(this._element).on(l.CLICK_DISMISS, n.DATA_DISMISS, a.proxy(this.hide, this)), 
                a(this._dialog).on(l.MOUSEDOWN_DISMISS, function() {
                    a(c._element).one(l.MOUSEUP_DISMISS, function(b) {
            ...
            value: function(b) {
                ...
                this._setEscapeEvent(), this._setResizeEvent(), a(document).off(l.FOCUSIN), a(this._element).removeClass(m.IN), 
                a(this._element).off(l.CLICK_DISMISS), a(this._dialog).off(l.MOUSEDOWN_DISMISS), 
                Util.supportsTransitionEnd() && a(this._element).hasClass(m.FADE) ? a(this._element).one(Util.TRANSITION_END, a.proxy(this._hideModal, this)).emulateTransitionEnd(h) : this._hideModal());
            }
        }, {
            key: "dispose",
            value: function() {
                a.removeData(this._element, d), a(window).off(e), a(document).off(e), a(this._element).off(e), 
                a(this._backdrop).off(e), this._config = null, this._element = null, this._dialog = null, 
            ...
            key: "_getConfig",
            value: function(c) {
                return c = a.extend({}, j, c), Util.typeCheckConfig(b, c, k), c;
            }
        }, {
            key: "_showElement",
            value: function(b) {
                var c = this, d = Util.supportsTransitionEnd() && a(this._element).hasClass(m.FADE);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), 
                this._element.style.display = "block", this._element.scrollTop = 0, d && Util.reflow(this._element), 
                a(this._element).addClass(m.IN), this._config.focus && this._enforceFocus();
                var e = a.Event(l.SHOWN, {
                    relatedTarget: b
                }), f = function() {
                    c._config.focus && c._element.focus(), a(c._element).trigger(e);
                };
                d ? a(this._dialog).one(Util.TRANSITION_END, f).emulateTransitionEnd(h) : f();
            }
        }, {
            key: "_enforceFocus",
            value: function() {
                var b = this;
                a(document).off(l.FOCUSIN).on(l.FOCUSIN, function(c) {
            ...
            value: function() {
                var b = this;
                this._isShown && this._config.keyboard ? a(this._element).on(l.KEYDOWN_DISMISS, function(a) {
                    27 === a.which && b.hide();
            ...
            key: "_setResizeEvent",
            value: function() {
                this._isShown ? a(window).on(l.RESIZE, a.proxy(this._handleUpdate, this)) : a(window).off(l.RESIZE);
            }
        }, {
            key: "_hideModal",
            value: function() {
                ...
                this._element.style.display = "none", this._showBackdrop(function() {
                    a(document.body).removeClass(m.OPEN), b._resetAdjustments(), b._resetScrollbar(), 
                    a(b._element).trigger(l.HIDDEN);
                });
            }
        }, {
            key: "_removeBackdrop",
            ...
            key: "_showBackdrop",
            value: function(b) {
                var c = this, d = a(this._element).hasClass(m.FADE) ? m.FADE : "";
                if (this._isShown && this._config.backdrop) {
                    var e = Util.supportsTransitionEnd() && d;
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = m.BACKDROP, 
                    d && a(this._backdrop).addClass(d), a(this._backdrop).appendTo(document.body), a(this._element).on(l.CLICK_DISMISS, function(a) {
                        return c._ignoreBackdropClick ? void (c._ignoreBackdropClick = !1) : void (a.target === a.currentTarget && ("static" === c._config.backdrop ? c._element.focus() : c.hide()));
                    }), e && Util.reflow(this._backdrop), a(this._backdrop).addClass(m.IN), !b) return;
                    if (!e) return void b();
                    a(this._backdrop).one(Util.TRANSITION_END, b).emulateTransitionEnd(i);
                } else if (!this._isShown && this._backdrop) {
                    a(this._backdrop).removeClass(m.IN);
                    var f = function() {
                        c._removeBackdrop(), b && b();
                    };
                    Util.supportsTransitionEnd() && a(this._element).hasClass(m.FADE) ? a(this._backdrop).one(Util.TRANSITION_END, f).emulateTransitionEnd(i) : f();
                } else b && b();
            }
        }, {
            key: "_handleUpdate",
            ...
            key: "_setScrollbar",
            value: function() {
                var b = parseInt(a(n.FIXED_CONTENT).css("padding-right") || 0, 10);
            ...
            value: function() {
                ...
                a.className = m.SCROLLBAR_MEASURER, document.body.appendChild(a);
            ...
            value: function(b, c) {
                return this.each(function() {
                    var e = a(this).data(d), g = a.extend({}, f.Default, a(this).data(), "object" == typeof b && b);
                    if (e || (e = new f(this, g), a(this).data(d, e)), "string" == typeof b) {
    ...
    return a(document).on(l.CLICK_DATA_API, n.DATA_TOGGLE, function(b) {
        var c = this, e = void 0, f = Util.getSelectorFromElement(this);
        f && (e = a(f)[0]);
        var g = a(e).data(d) ? "toggle" : a.extend({}, a(e).data(), a(this).data());
        "A" === this.tagName && b.preventDefault();
        var h = a(e).one(l.SHOW, function(b) {
            b.isDefaultPrevented() || h.one(l.HIDDEN, function() {
                a(c).is(":visible") && c.focus();
            });
        });
        o._jQueryInterface.call(a(e), g, this);
    }), a.fn[b] = o._jQueryInterface, a.fn[b].Constructor = o, a.fn[b].noConflict = function() {
        return a.fn[b] = g, o._jQueryInterface;
    }, o;
}(jQuery), _createClass = function() {
    ...
    var b = "tab", c = "4.0.0-alpha", d = "bs.tab", e = "." + d, f = ".data-api", g = a.fn[b], h = 150, i = {
        HIDE: "hide" + e,
        HIDDEN: "hidden" + e,
        SHOW: "show" + e,
        SHOWN: "shown" + e,
        ...
        return _createClass(b, [ {
            ...
            value: function() {
                var b = this;
                if (!this._element.parentNode || this._element.parentNode.nodeType !== Node.ELEMENT_NODE || !a(this._element).hasClass(j.ACTIVE)) {
                    var c = void 0, d = void 0, e = a(this._element).closest(k.UL)[0], f = Util.getSelectorFromElement(this._element);
                    e && (d = a.makeArray(a(e).find(k.ACTIVE)), d = d[d.length - 1]);
                    var g = a.Event(i.HIDE, {
                        relatedTarget: this._element
                    }), h = a.Event(i.SHOW, {
                        relatedTarget: d
                    });
                    if (d && a(d).trigger(g), a(this._element).trigger(h), !h.isDefaultPrevented() && !g.isDefaultPrevented()) {
                        ...
                        c ? this._activate(c, c.parentNode, l) : l();
                    }
                }
            }
        }, {
            ...
            value: function(b, c, d) {
                var e = a(c).find(k.ACTIVE_CHILD)[0], f = d && Util.supportsTransitionEnd() && (e && a(e).hasClass(j.FADE) || Boolean(a(c).find(k.FADE_CHILD)[0])), g = a.proxy(this._transitionComplete, this, b, e, f, d);
                e && f ? a(e).one(Util.TRANSITION_END, g).emulateTransitionEnd(h) : g(), e && a(e).removeClass(j.IN);
            }
        }, {
            key: "_transitionComplete",
            value: function(b, c, d, e) {
                if (c) {
                    a(c).removeClass(j.ACTIVE);
                    var f = a(c).find(k.DROPDOWN_ACTIVE_CHILD)[0];
                    f && a(f).removeClass(j.ACTIVE), c.setAttribute("aria-expanded", !1);
                }
                if (a(b).addClass(j.ACTIVE), b.setAttribute("aria-expanded", !0), d ? (Util.reflow(b), 
                a(b).addClass(j.IN)) : a(b).removeClass(j.FADE), b.parentNode && a(b.parentNode).hasClass(j.DROPDOWN_MENU)) {
                    var g = a(b).closest(k.DROPDOWN)[0];
                    g && a(g).find(k.DROPDOWN_TOGGLE).addClass(j.ACTIVE), b.setAttribute("aria-expanded", !0);
                }
                e && e();
            }
        } ], [ {
            ...
            value: function(c) {
                return this.each(function() {
                    var e = a(this), f = e.data(d);
                    if (f || (f = f = new b(this), e.data(d, f)), "string" == typeof c) {
...
!function(a, b, c, d) {
    ...
    function b(a, b) {
        this.previewElement = a, this.options = b, this.animationLoaded = !1;
    }
    b.prototype = {
        activate: function() {
        ...
        wrap: function() {
            this.previewElement.addClass("gifplayer-ready"), this.wrapper = this.previewElement.wrap("<div class='gifplayer-wrapper'></div>").parent(), 
            this.wrapper.css("width", this.previewElement.width()), this.wrapper.css("height", this.previewElement.height()), 
            this.previewElement.css("cursor", "pointer");
        },
        addSpinner: function() {
            this.spinnerElement = a("<div class = 'spinner'></div>"), this.wrapper.append(this.spinnerElement), 
            this.spinnerElement.hide();
        },
        getOption: function(a) {
            var b = this.previewElement.data(a.toLowerCase());
            return void 0 != b && "" != b ? b : this.options[a];
        },
        addControl: function() {
            var b = this.getOption("label");
            this.playElement = a("<ins class='play-gif'>" + b + "</ins>"), this.wrapper.append(this.playElement), 
            this.playElement.css("top", this.previewElement.height() / 2 - this.playElement.height() / 2), 
            this.playElement.css("left", this.previewElement.width() / 2 - this.playElement.width() / 2);
        },
        addEvents: function() {
            var a = this, b = this.getOption("playOn");
            this.getOption("mode");
            switch (b) {
              case "click":
                a.playElement.on("click", function(b) {
                    a.loadAnimation();
                }), a.previewElement.on("click", function(b) {
                    a.loadAnimation(), b.preventDefault(), b.stopPropagation();
                });
                break;

              case "hover":
                a.previewElement.on("click mouseover", function(b) {
                    a.loadAnimation(), b.preventDefault(), b.stopPropagation();
                });
            }
        },
        loadAnimation: function() {
            ...
            var a = this.getOption("mode");
            "gif" == a ? this.loadGif() : "video" == a && this.loadVideo();
        },
        stopGif: function() {
            this.gifElement.hide(), this.previewElement.show(), this.playElement.show(), this.resetEvents();
        },
        getGif: function() {
            var a = this.getOption("gif");
            return void 0 != a && "" != a ? a : this.previewElement.attr("src").replace(".png", ".gif").replace(".jpg", ".gif");
        },
        getWebm: function() {
            var a = this.getOption("webm");
            return void 0 != a && "" != a ? a : this.previewElement.attr("src").replace(".png", ".webm").replace(".jpg", ".webm");
        },
        getMp4: function() {
            var a = this.getOption("mp4");
            return void 0 != a && "" != a ? a : this.previewElement.attr("src").replace(".png", ".mp4").replace(".jpg", ".mp4");
        },
        loadGif: function() {
            var b = this;
            b.playElement.hide(), this.animationLoaded || this.enableAbort();
            var c = this.getGif(), d = this.previewElement.width(), e = this.previewElement.height();
            this.gifElement = a("<img class='gp-gif-element' width='" + d + "' height=' " + e + " '/>");
            var f = this.getOption("wait");
            f ? this.gifElement.load(function() {
                b.animationLoaded = !0, b.resetEvents(), b.previewElement.hide(), b.wrapper.append(b.gifElement), 
                b.spinnerElement.hide();
            }) : (b.animationLoaded = !0, b.resetEvents(), b.previewElement.hide(), b.wrapper.append(b.gifElement), 
            b.spinnerElement.hide()), this.gifElement.css("cursor", "pointer"), this.gifElement.css("position", "absolute"), 
            this.gifElement.css("top", "0"), this.gifElement.css("left", "0"), this.gifElement.attr("src", c), 
            this.gifElement.click(function(c) {
                a(this).remove(), b.previewElement.show(), b.playElement.show(), b.resetEvents(), 
                c.preventDefault(), c.stopPropagation();
            });
        },
        loadVideo: function() {
            var b = this, c = this.getMp4(), d = this.getWebm(), e = this.previewElement.width(), f = this.previewElement.height();
            b.videoElement = a('<video class="gp-video-element" width="' + e + 'px" height="' + f + '" style="margin:0 auto;width:' + e + "px;height:" + f + 'px;" autoplay="autoplay" loop="loop" muted="muted" poster="' + b.previewElement.attr("src") + '"><source type="video/mp4" src="' + c + '"><source type="video/webm" src="' + d + '"></video>');
            var g = function() {
                b.spinnerElement.hide(), b.previewElement.hide(), b.playElement.hide(), b.gifLoaded = !0, 
                b.previewElement.hide(), b.wrapper.append(b.videoElement), b.videoPaused = !1, b.videoElement[0].play();
            }, h = function() {
                4 === b.videoElement[0].readyState ? (g(), b.animationLoaded = !0) : setTimeout(h, 100);
            }, i = this.getOption("wait");
            i ? h() : g(), b.videoElement.on("click", function() {
                b.videoPaused ? b.resumeVideo() : b.pauseVideo();
            });
        },
        pauseVideo: function() {
            var a = this;
            a.videoPaused = !0, a.videoElement[0].pause(), a.playElement.show(), a.mouseoverEnabled = !1;
        },
        resumeVideo: function() {
            var a = this;
            a.videoPaused = !1, a.videoElement[0].play(), a.playElement.hide();
        },
        ...
        abortLoading: function(a) {
            this.spinnerElement.hide(), this.playElement.show(), a.preventDefault(), a.stopPropagation(), 
            this.gifElement.off("load").on("load", function(a) {
                a.preventDefault(), a.stopPropagation();
            }), this.resetEvents();
        },
        resetEvents: function() {
            this.previewElement.off("click"), this.previewElement.off("mouseover"), this.playElement.off("click"), 
            this.spinnerElement.off("click"), this.addEvents();
        }
    }, a.fn.gifplayer = function(c) {
        if (!/^(play|pause|stop)$/i.test(c)) return this.each(function() {
            c = a.extend({}, a.fn.gifplayer.defaults, c);
            var d = new b(a(this), c);
            d.activate();
        });
        if (c = c.toLowerCase(), a(this).hasClass("gifplayer-ready")) {
            var d = new b(a(this), null);
            switch (d.options = {}, d.options = a.extend({}, a.fn.gifplayer.defaults, d.options), 
            d.wrapper = a(this).parent(), d.spinnerElement = d.wrapper.find(".spinner"), d.playElement = d.wrapper.find(".play-gif"), 
            d.gifElement = d.wrapper.find(".gp-gif-element"), d.videoElement = d.wrapper.find(".gp-video-element"), 
            void 0 != d.gifElement ? d.options.mode = "gif" : void 0 != d.videoElement && (d.options.mode = "video"), 
            c) {
              case "play":
                console.log("play"), d.playElement.trigger("click");
                break;

              case "stop":
                console.log("stop"), "gif" == d.options.mode ? d.stopGif() : "video" == d.options.mode && d.pauseVideo();
            }
        } else console.log("Not a valid gifplayer element");
    }, a.fn.gifplayer.defaults = {
        label: "GIF",
        playOn: "click",
        mode: "gif",
        gif: "",
    ...
    function b() {
        var b = f.settings;
        if (b.autoDispose && !a.contains(document.documentElement, this)) return a(this).timeago("dispose"), 
        this;
        var g = c(this);
        return isNaN(g.datetime) || (0 == b.cutoff || Math.abs(e(g.datetime)) < b.cutoff) && a(this).text(d(g.datetime)), 
        this;
    }
    function c(b) {
    ...
    a.extend(a.timeago, {
        ...
        inWords: function(b) {
            function c(c, e) {
                var f = a.isFunction(c) ? c(e, b) : c, g = d.numbers && d.numbers[e] || e;
            ...
            var d = this.settings.strings, e = d.prefixAgo, f = d.suffixAgo;
            if (this.settings.allowFuture && 0 > b && (e = d.prefixFromNow, f = d.suffixFromNow), 
            !this.settings.allowPast && b >= 0) return this.settings.strings.inPast;
            var g = Math.abs(b) / 1e3, h = g / 60, i = h / 60, j = i / 24, k = j / 365, l = 45 > g && c(d.seconds, Math.round(g)) || 90 > g && c(d.minute, 1) || 45 > h && c(d.minutes, Math.round(h)) || 90 > h && c(d.hour, 1) || 24 > i && c(d.hours, Math.round(i)) || 42 > i && c(d.day, 1) || 30 > j && c(d.days, Math.round(j)) || 45 > j && c(d.month, 1) || 365 > j && c(d.months, Math.round(j / 30)) || 1.5 > k && c(d.year, 1) || c(d.years, Math.round(k)), m = d.wordSeparator || "";
            return void 0 === d.wordSeparator && (m = " "), a.trim([ e, l, f ].join(m));
        },
        parse: function(b) {
            var c = a.trim(b);
            return c = c.replace(/\.\d+/, ""), c = c.replace(/-/, "/").replace(/-/, "/"), c = c.replace(/T/, " ").replace(/Z/, " UTC"), 
            c = c.replace(/([\+\-]\d\d)\:?(\d\d)/, " $1$2"), c = c.replace(/([\+\-]\d\d)$/, " $100"), 
            new Date(c);
        },
        datetime: function(b) {
