...
smokeImage.src = $(".banner").data("smoke"); // '{{ site.url }}/media/theme-bb/smoke.png'; //document.getElementsByTagName("img")[1].src;
...
function initxxx() {
    ...
    img_smoke_1.src = $(".banner").data("smoke-one"); // '{{ site.url }}/media/theme-bb/smoke_1.png';
    img_smoke_2.src = $(".banner").data("smoke-two"); // '{{ site.url }}/media/theme-bb/smoke_2.png';
    img_smoke_3.src = $(".banner").data("smoke-tree"); // '{{ site.url }}/media/theme-bb/smoke_3.png'; //'img/smoke_3.png';
